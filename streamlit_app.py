                    ...
                    for pos, incoming in new_placements.items():
                        ...
                        if len(incoming) == 1:
                            ...
                            for defender_owner, defender_type in incoming[1:]:
                                st.write(f"incoming collision: {attacker_owner}, {attacker_type}, {defender_owner}, {defender_type}")
                        ...
                        if existing_type is not None:
                            collided = True
                            st.write(f"collision w existing: {current_type}, {current_owner}, {existing_type}, {existing_owner}")
